...
export class HlmAvatarBadge {
  constructor() {
    classes(() => [
      'bg-(--primary-600) text-primary-foreground ring-background absolute right-0 bottom-0 z-10 inline-flex items-center justify-center rounded-full bg-blend-color ring-2 select-none',
